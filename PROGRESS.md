...
- **CI 실측**: 최종 클린런 `a22ca57` = 계측 16/16·키오스크 6/6·스크린샷 7/7 가로 전부 success. 플레이어 스테이지 **(0,0,0) 99.6% 검정**(이전 커밋까진 흰색), 시간텍스트 흰색 y≈803·진행트랙 전폭 y≈888 상시 하단. 메인 헤더 y≈668·카드 y≈774(간격 ~78px≈32dp, 블록중앙 991≈영역중앙 995), 카드폭 92.7% 불변. 뷰어 재배포 https://nowflix-ci-view.vercel.app (200). (중간: d59e26c 런은 kiosk가 인프라 행으로 cancelled였고, kiosk 코드는 cba5314와 바이트 동일이라 a22ca57에서 클린 재확인.)
